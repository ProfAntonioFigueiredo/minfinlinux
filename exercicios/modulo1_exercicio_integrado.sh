...
echo "📁 Comando: Criando diretório de trabalho para exercício integrado"
...
echo "📊 Comando: 1.1 - Informações do Sistema"
...
echo "📊 Comando: 1.2 - Estrutura de Diretórios"
...
echo "📁 Comando: 2.1 - Criando estrutura para projeto do Ministério das Finanças"
...
echo "📁 Comando: 2.2 - Verificando estrutura criada"
...
echo "📄 Comando: 3.1 - Criando arquivos de configuração"
...
echo "📄 Comando: 3.2 - Criando script de backup"
...
echo "📄 Comando: 3.3 - Criando relatório de exemplo"
...
echo "👤 Comando: 5.1 - Criando grupos de trabalho"
...
echo "👤 Comando: 5.2 - Criando usuários de teste"
...
echo "👤 Comando: 5.3 - Verificando usuários e grupos"
...
echo "🔧 Comando: 6.1 - Informações do sistema"
echo ""
...
echo "🔧 Comando: 6.2 - Processos em execução"
echo ""
6.2 - Processos em execução
echo "Top 5 processos por uso de CPU:"
ps aux --sort=-%cpu | head -6
echo ""

echo "🔧 Comando: 6.3 - Serviços do sistema"
echo ""
6.3 - Serviços do sistema
echo "Serviços ativos:"
systemctl list-units --type=service --state=active | head -10
echo ""

echo "🔧 Comando: 6.4 - Criando serviço de monitoramento"
echo ""
6.4 - Criando serviço de monitoramento
...
echo "✅ Comando: 7.1 - Executando script de backup"
echo "✅ 7.1 - Executando script de backup:"
cd minfin_sistema
./scripts/backup.sh
echo ""

echo "✅ Comando: 7.2 - Executando script de monitoramento"
echo "✅ 7.2 - Executando script de monitoramento:"
./scripts/monitor.sh
echo ""

echo "✅ Comando: 7.3 - Verificando estrutura final"
echo "✅ 7.3 - Verificando estrutura final:"
echo "Estrutura completa do projeto:"
tree . || find . -type f | sort
echo ""

echo "✅ Comando: 7.4 - Verificando permissões finais"
