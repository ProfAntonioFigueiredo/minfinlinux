...
# =============================================================================
# EXERCÍCIO: PROCESSOS E SERVIÇOS
# Módulo 1 - Treinamento Linux MINFIN Angola
# =============================================================================

echo "⚙️  EXERCÍCIO: PROCESSOS E SERVIÇOS"
echo "=================================="
echo ""
...
# Exercício 1: Informações básicas do sistema
echo "📝 EXERCÍCIO 1: Informações básicas do sistema"
echo "---------------------------------------------"
...
#!/bin/bash
while true; do
    echo "$(date): Serviço de teste ativo" >> /tmp/servico_teste.log
    sleep 10
done
EOF
...
ps -p $SERVICO_PID 2>/dev/null || echo "✅ Processo terminado com sucesso"
echo ""
...
echo "🔥 Uso de CPU (se iostat estiver disponível):"
if command -v iostat >/dev/null 2>&1; then
    iostat 1 1
else
    echo "ℹ️  iostat não disponível"
fi
echo ""
...
# Exercício 12: Limpeza
echo "📝 EXERCÍCIO 12: Limpeza"
echo "-----------------------"
...
echo "• ps -aux                     - Listar todos os processos"
echo "• ps -aux --sort=-%cpu        - Ordenar por CPU"
echo "• top                         - Monitoramento em tempo real"
echo "• pgrep nome_processo         - Encontrar PID por nome"
echo "• pidof nome_processo         - PID de processo"
echo "• kill -TERM PID              - Terminar graciosamente"
echo "• kill -KILL PID              - Forçar terminação"
echo "• kill -STOP PID              - Pausar processo"
echo "• kill -CONT PID              - Continuar processo"
echo "• systemctl status servico    - Status do serviço"
echo "• systemctl start servico    - Iniciar serviço"
echo "• systemctl stop servico     - Parar serviço"
echo "• journalctl -n 10            - Últimas 10 linhas"
echo "• journalctl -p err           - Apenas erros"
echo "• uptime                      - Tempo de atividade"
echo "• w                           - Usuários logados"
echo "• free -h                     - Uso de memória"
echo "• df -h                       - Uso de disco"
echo ""

echo "✅ Exercício de processos e serviços concluído!"
echo "=================================="
